...
/*
 * 1. tests whether that the entry returns ZERO because of the input
 * 2. makes sure the exception is thrown for wrong column num
 * 3. makes sure the exception is thrown for wrong row num
 * 4. makes sure that the same object is returned
 * 5. checks that the output should not be Entry.ONE
 */

public class Test_analyze_model_TruthTable_getInputEntry {
	...
	public void test1() {
		...
		ent1 = tru1.getInputEntry(0, 10);
		ent2 = tru2.getInputEntry(0, 10);
		ent3 = tru3.getInputEntry(0, 10);
	...
	public void test2() {
		...
		try
		{
			ent1 = tru1.getInputEntry(0, -1);
		}
		catch(IllegalArgumentException e)
		{
			System.out.println("Test 2 AnalyzeModel TruthTable getInputEntry: " + e);
		}
		try
		{
			ent2 = tru2.getInputEntry(4, -6);
		}
		catch(IllegalArgumentException e)
		{
			System.out.println("Test 2 AnalyzeModel TruthTable getInputEntry: " + e);
